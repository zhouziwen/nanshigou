...
public class GoodsDetailListAdapter extends BaseAdapter {
    ...
    public GoodsDetailListAdapter(Activity activity, ArrayList<HashMap<String, String>> arrayList) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        holder.verPriceTextView.setVisibility(View.GONE);
        ...
        holder.verRelativeLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ActivityUtil.finish(GoodsDetailActivity.mActivity);
